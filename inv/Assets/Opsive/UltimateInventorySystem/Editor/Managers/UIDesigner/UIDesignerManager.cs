...
namespace Opsive.UltimateInventorySystem.Editor.Managers.UIDesigner
{
    ...
    public class UIDesignerManager : InventoryManager
    {
        ...
        protected (UIDesignerSchema.ValidationState validationState, string message) m_UIDesignerValidationResult = 
            (UIDesignerSchema.ValidationState.HasErrors, "Not Yet Checked");
        public (UIDesignerSchema.ValidationState validationState, string message) UIDesignerValidationResult => m_UIDesignerValidationResult;
        ...
        private (UIDesignerSchema.ValidationState validationState, string message) IsSetupValid()
        {
            if (Application.isPlaying) {
                return (UIDesignerSchema.ValidationState.HasErrors,
                    "You may not use the UI Designer at runtime!");
            }
            ...
            if (IsSchemaFromOpsive()) {
                return (UIDesignerSchema.ValidationState.HasErrors,
                    "It is required to duplicate one of the available schemas before continuing, this ensures you keep the prefabs in your project folders.");
            }
